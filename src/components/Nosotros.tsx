	...
	return (
		<section className="px-32 h-full py-16 flex flex-col gap-4">
			...
			<div className="flex justify-between">
				<MemberCard>
					<MemberPhoto width={175} path="RySC/assets/img/female-student.svg" />
					<MemberName name="Valeria Ysabel González Meneses" />
				</MemberCard>
				<MemberCard>
					<MemberPhoto width={175} path="RySC/assets/img/male-student1.svg" />
					<MemberName name="Raúl Antonio Villanueva Hernández" />
				</MemberCard>
				<MemberCard>
					<MemberPhoto width={175} path="RySC/assets/img/male-student2.svg" />
